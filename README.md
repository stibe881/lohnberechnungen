...
- **Zeugnisse hinzufügen:** Ist das Bewerbungsdossier eine einzige PDF-Datei (Lebenslauf, Schreiben, Zeugnisse, Diplome, oft als Scans), liest Claude die Zeugnisse darin mit und belegt die Stellen; dafür muss «Nur Text an Claude senden» aus sein, weil gescannte Seiten keinen Text enthalten. Ohne Claude zeigt die App an, welche Seiten gescannt sind und nicht gelesen wurden. Lebenslauf und Zeugnisse können auch als einzelne Dateien zusammen hochgeladen werden – die App erkennt Zeugnisse am Inhalt und ordnet sie der Person zu (bei genau einem Lebenslauf im Stapel; werden nur Zeugnisse hochgeladen, gehören sie zur gerade geöffneten Person). Bei der Person lassen sich Arbeitszeugnisse, Zwischenzeugnisse, Arbeitsbestätigungen, Verträge und Diplome (PDF, Word, Text) hochladen. Die App liest Ein- und Austrittsdatum mit Tag sowie das Pensum heraus, ordnet sie den Stellen aus dem Lebenslauf zu (mit Claude oder über Arbeitgeber und Zeitraum) und markiert diese als «belegt»; Stellen, die im Lebenslauf fehlen, werden ergänzt. Alles ist rückgängig. Die Dokumente selbst werden nicht gespeichert, nur die ausgelesenen Angaben.
